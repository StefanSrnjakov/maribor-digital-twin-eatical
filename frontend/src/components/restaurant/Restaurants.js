                ...
                <div className="row">
                    <div className="col-3 d-flex flex-column flex-shrink-0 p-3 bg-light"
                        ...
                        <span>
                            {
                                this.state.showAll ?
                                    <button type="button" className="btn btn-info btn-sm" name="all" id="all"
                                            onClick={this.componentDidMount.bind(this)}>All</button>
                                    :
                                    <button type="button" className="btn btn-outline-info btn-sm" name="all" id="all"
                                            onClick={this.componentDidMount.bind(this)}>All</button>
                            }
                            <>  </>
                            {
                                this.state.showNearby ?
                                    <button type="button" className="btn btn-info btn-sm" name="nearby" id="nearby"
                                            onClick={this.fetchNearby.bind(this)}>Nearby</button>
                                    :
                                    <button type="button" className="btn btn-outline-info btn-sm" name="nearby"
                                            id="nearby" onClick={this.fetchNearby.bind(this)}>Nearby</button>
                            }
                        </span>
